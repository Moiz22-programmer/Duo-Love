        ...
        <div className="cosmic-card rounded-3xl p-8 md:p-10 space-y-6 text-center max-w-md w-full mx-auto md:ml-auto">
          ...
          <div className="space-y-3 pt-2">
            ...
            <form
              onSubmit={(e) => {
                ...
                const user: User = {
                  ...
                  photoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&auto=format&fit=crop&q=80',
                  createdAt: Date.now(),
                  statusMessage: 'In the celestial sanctuary 💕',
                };
                onSignInWithGoogle(user);
              }}
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white/[0.05] hover:bg-white/[0.1] text-slate-200 border border-white/10 hover:border-white/20 py-2.5 px-4 rounded-xl flex items-center justify-center gap-2.5 text-xs font-semibold transition-all cursor-pointer disabled:opacity-60"
            >
              ...
              <span>{isLoading ? 'Connecting...' : 'Sign in with Google OAuth'}</span>
            </button>
            ...
            <div className="flex items-center justify-between text-xs pt-1 px-1">
              ...
              <button
                ...
                className="text-[#f5a623] hover:underline transition-colors cursor-pointer text-[11px] font-semibold"
              >
                Create Account →
              </button>
            </div>
